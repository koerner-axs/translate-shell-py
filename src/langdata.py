...
def init_locales():
    ...
    _for_code("af")["translations-of"]    = "Vertalings van"
    _for_code("af")["definitions-of"]     = "Definisies van"
    ...
    _for_code("sq")["translations-of"]    = "Përkthimet e"
    _for_code("sq")["definitions-of"]     = "Përkufizime të"
    ...
    _for_code("ar")["translations-of"]    = "ترجمات"
    _for_code("ar")["definitions-of"]     = "تعريفات"
    ...
    _for_code("eu")["definitions-of"]     = "Honen definizioak:"
    ...
    _for_code("be")["translations-of"]    = "Пераклады"
    _for_code("be")["definitions-of"]     = "Вызначэннi"
    ...
    _for_code("bs")["translations-of"]    = "Prijevod za:"
    _for_code("bs")["definitions-of"]     = "Definicije za"
    ...
    _for_code("bg")["translations-of"]    = "Преводи на"
    _for_code("bg")["definitions-of"]     = "Дефиниции за"
    ...
    _for_code("ca")["translations-of"]    = "Traduccions per a"
    _for_code("ca")["definitions-of"]     = "Definicions de:"
    ...
    _for_code("ceb")["definitions-of"]    = "Mga kahulugan sa"
    ...
    _for_code("ny")["translations-of"]    = "Matanthauzidwe a"
    _for_code("ny")["definitions-of"]     = "Mamasulidwe a"
    ...
    _for_code("co")["translations-of"]    = "Traductions de"
    _for_code("co")["definitions-of"]     = "Définitions de"
    ...
    _for_code("hr")["translations-of"]    = "Prijevodi riječi ili izraza"
    _for_code("hr")["definitions-of"]     = "Definicije riječi ili izraza"
    ...
    _for_code("cs")["translations-of"]    = "Překlad výrazu"
    _for_code("cs")["definitions-of"]     = "Definice výrazu"
    ...
    _for_code("da")["translations-of"]    = "Oversættelser af"
    _for_code("da")["definitions-of"]     = "Definitioner af"
    ...
    _for_code("nl")["translations-of"]    = "Vertalingen van"
    _for_code("nl")["definitions-of"]     = "Definities van"
    ...
    _for_code("en")["translations-of"]    = "Translations of"
    _for_code("en")["definitions-of"]     = "Definitions of"
    ...
    _for_code("eo")["translations-of"]    = "Tradukoj de"
    _for_code("eo")["definitions-of"]     = "Difinoj de"
    ...
    _for_code("tl")["translations-of"]    = "Mga pagsasalin ng"
    _for_code("tl")["definitions-of"]     = "Mga kahulugan ng"
    ...
    _for_code("fi")["translations-of"]    = "Käännökset tekstille"
    _for_code("fi")["definitions-of"]     = "Määritelmät kohteelle"
    ...
    _for_code("fr")["translations-of"]    = "Traductions de"
    _for_code("fr")["definitions-of"]     = "Définitions de"
    ...
    _for_code("fr-CA")["translations-of"] = "Traductions de"
    _for_code("fr-CA")["definitions-of"]  = "Définitions de"
    ...
    _for_code("gl")["translations-of"]    = "Traducións de"
    _for_code("gl")["definitions-of"]     = "Definicións de"
    ...
    _for_code("de")["translations-of"]    = "Übersetzungen für"
    _for_code("de")["definitions-of"]     = "Definitionen von"
    ...
    _for_code("el")["translations-of"]    = "Μεταφράσεις του"
    _for_code("el")["definitions-of"]     = "Όρισμοί"
    ...
    _for_code("ht")["translations-of"]    = "Tradiksyon"
    _for_code("ht")["definitions-of"]     = "Definisyon nan"
    ...
    _for_code("ha")["translations-of"]    = "Fassarar"
    _for_code("ha")["definitions-of"]     = "Ma'anoni na"
    ...
    _for_code("he")["translations-of"]    = "תרגומים של"
    _for_code("he")["definitions-of"]     = "הגדרות של"
    ...
    _for_code("hmn")["translations-of"]   = "Lus txhais:"
    ...
    _for_code("is")["translations-of"]    = "Þýðingar á"
    ...
    _for_code("ig")["translations-of"]    = "Ntụgharị asụsụ nke"
    _for_code("ig")["definitions-of"]     = "Nkọwapụta nke"
    ...
    _for_code("id")["translations-of"]    = "Terjemahan dari"
    _for_code("id")["definitions-of"]     = "Definisi"
    ...
    _for_code("ga")["translations-of"]    = "Aistriúcháin ar"
    _for_code("ga")["definitions-of"]     = "Sainmhínithe ar"
    ...
    _for_code("it")["translations-of"]    = "Traduzioni di"
    _for_code("it")["definitions-of"]     = "Definizioni di"
    ...
    _for_code("jv")["translations-of"]    = "Terjemahan"
    _for_code("jv")["definitions-of"]     = "Arti"
    ...
    _for_code("km")["translations-of"]    = "ការ​បក​ប្រែ​នៃ"
    _for_code("km")["definitions-of"]     = "និយមន័យ​នៃ​"
    ...
    _for_code("lo")["translations-of"]    = "ຄຳ​ແປ​ສຳລັບ"
    _for_code("lo")["definitions-of"]     = "ຄວາມໝາຍຂອງ"
    _for_code("lo")["synonyms"]           = "ຄຳທີ່ຄ້າຍກັນ"
    ...
    _for_code("la")["translations-of"]    = "Versio de"
    ...
    _for_code("mk")["translations-of"]    = "Преводи на"
    _for_code("mk")["definitions-of"]     = "Дефиниции на"
    ...
    _for_code("mg")["translations-of"]    = "Dikan'ny"
    _for_code("mg")["definitions-of"]     = "Famaritana ny"
    ...
    _for_code("ms")["translations-of"]    = "Terjemahan"
    _for_code("ms")["definitions-of"]     = "Takrif"
    ...
    _for_code("mt")["translations-of"]    = "Traduzzjonijiet ta'"
    _for_code("mt")["definitions-of"]     = "Definizzjonijiet ta'"
    ...
    _for_code("mi")["translations-of"]    = "Ngā whakamāoritanga o"
    _for_code("mi")["definitions-of"]     = "Ngā whakamārama o"
    ...
    _for_code("no")["translations-of"]    = "Oversettelser av"
    _for_code("no")["definitions-of"]     = "Definisjoner av"
    ...
    _for_code("fa")["translations-of"]    = "ترجمه‌های"
    _for_code("fa")["definitions-of"]     = "تعریف‌های"
    ...
    _for_code("pl")["translations-of"]    = "Tłumaczenia"
    ...
    _for_code("pt-BR")["translations-of"] = "Traduções de"
    _for_code("pt-BR")["definitions-of"]  = "Definições de"
    ...
    _for_code("pt-PT")["translations-of"] = "Traduções de"
    _for_code("pt-PT")["definitions-of"]  = "Definições de"
    ...
    _for_code("pa")["definitions-of"]     = "ਦੀਆਂ ਪਰਿਭਾਸ਼ਾ"
    ...
    _for_code("ro")["translations-of"]    = "Traduceri pentru"
    _for_code("ro")["definitions-of"]     = "Definiții pentru"
    ...
    _for_code("gd")["translations-of"]    = "Eadar-theangachadh airson"
    _for_code("gd")["definitions-of"]     = "Deifiniseanan airson"
    ...
    _for_code("sr-Cyrl")["definitions-of"]  = "Дефиниције за"
    ...
    _for_code("sr-Latn")["definitions-of"]  = "Definicije za"
    ...
    _for_code("st")["translations-of"]    = "Liphetolelo tsa"
    _for_code("st")["definitions-of"]     = "Meelelo ea"
    ...
    _for_code("sn")["translations-of"]    = "Shanduro dze"
    _for_code("sn")["definitions-of"]     = "Zvinoreva"
    ...
    _for_code("sk")["translations-of"]    = "Preklady výrazu:"
    _for_code("sk")["definitions-of"]     = "Definície výrazu"
    ...
    _for_code("sl")["translations-of"]    = "Prevodi za"
    _for_code("sl")["definitions-of"]     = "Razlage za"
    ...
    _for_code("so")["translations-of"]    = "Turjumaada"
    _for_code("so")["definitions-of"]     = "Qeexitaannada"
    ...
    _for_code("es")["translations-of"]    = "Traducciones de"
    _for_code("es")["definitions-of"]     = "Definiciones de"
    ...
    _for_code("su")["translations-of"]    = "Tarjamahan tina"
    _for_code("su")["definitions-of"]     = "Panjelasan tina"
    ...
    _for_code("sw")["translations-of"]    = "Tafsiri ya"
    _for_code("sw")["definitions-of"]     = "Ufafanuzi wa"
    ...
    _for_code("sv")["translations-of"]    = "Översättningar av"
    _for_code("sv")["definitions-of"]     = "Definitioner av"
    ...
    _for_code("tg")["translations-of"]    = "Тарҷумаҳои"
    _for_code("tg")["definitions-of"]     = "Таърифҳои"
    ...
    _for_code("th")["translations-of"]    = "คำแปลของ"
    _for_code("th")["definitions-of"]     = "คำจำกัดความของ"
    ...
    _for_code("ur")["translations-of"]    = "کے ترجمے"
    _for_code("ur")["definitions-of"]     = "کی تعریفات"
    ...
    _for_code("vi")["translations-of"]    = "Bản dịch của"
    _for_code("vi")["definitions-of"]     = "Nghĩa của"
    ...
    _for_code("cy")["translations-of"]    = "Cyfieithiadau"
    _for_code("cy")["definitions-of"]     = "Diffiniadau"
    ...
    _for_code("fy")["translations-of"]    = "Oersettings fan"
    _for_code("fy")["definitions-of"]     = "Definysjes fan"
    ...
    _for_code("yi")["translations-of"]    = "איבערזעצונגען פון"
    _for_code("yi")["definitions-of"]     = "דפיניציונען"
    ...
    _for_code("yo")["translations-of"]    = "Awọn itumọ ti"
    _for_code("yo")["definitions-of"]     = "Awọn itumọ ti"
...
def comp_name(i1, v1, i2, v2):
    """Comparator using get_name()."""
    name1 = get_name(i1)
    name2 = get_name(i2)
    if name1 < name2:
        return -1
...
def ansi(style, text):
    """Return text with ANSI formatting (placeholder implementation)."""
    # This is a placeholder - implement based on your ANSI formatting needs
    return text
...
def get_details(code):
    ...
    result = f"{ansi('bold', get_display(code))}\n"
    result += f"{'Name':<22}{ansi('bold', names)}\n"
    result += f"{'Family':<22}{ansi('bold', get_family(code))}\n"
    result += f"{'Writing system':<22}{ansi('bold', script)}\n"
    result += f"{'Code':<22}{ansi('bold', get_code(code))}\n"
    result += f"{'ISO 639-3':<22}{ansi('bold', iso)}\n"
    result += f"{'SIL':<22}{ansi('bold', f'https://iso639-3.sil.org/code/{iso}')}\n"

    if get_glotto(code):
        result += f"{'Glottolog':<22}{ansi('bold', f'https://glottolog.org/resource/languoid/id/{get_glotto(code)}')}\n"
    else:
        result += f"{'Glottolog':<22}\n"

    result += f"{'Wikipedia':<22}{ansi('bold', f'https://en.wikipedia.org/wiki/ISO_639:{iso}')}\n"
    ...
    if LOCALES[locale_code].get("supported-by"):
        ...
        result += f"{'Translator support':<22}Google [{google_check}]    Bing [{bing_check}]\n"
...
def ins(level, text, code=None, width=None):
    """Convert a logical string to visual with a certain level of indentation."""
    if code and is_rtl(code):
        width = width or 80
        return s(text, code, width - 4 * level)
    else:
        return " " * (4 * level) + text
